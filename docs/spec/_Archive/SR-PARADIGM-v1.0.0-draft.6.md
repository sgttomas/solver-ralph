    ...
    development_paradigm:
      ...
      boot_alignment_prerequisites:
        note: >
          ...
          Boot prerequisites are expressed as governance *categories* that MUST be satisfied to boot a
        ...
        required_categories:
          ...
          - id: "governance.directive"
            ...
            purpose: "Executable phase structure; deliverables/gates; verification profiles."
...
# SOLVER-Ralph Development Paradigm (SR-PARADIGM) — v1.0.0-draft.6
...
- Governability score (all criteria pass / partial / blocked)
- Identified issues for each failing criterion
...
| Failure | Remediation |
|---------|-------------|
| Not scoped | Narrow scope via boundary negotiation |
| Not testable | Identify evidence types; may need portal if no oracle possible |
| Authority unclear | Identify approval authority; escalate if organizational ambiguity |
| Unstable | Wait for stability; or explicitly version the problem statement |
| Not decomposable | Break into sub-problems; each re-enters at C0 |

If governability cannot be achieved, do not proceed to S0.3. Continue remediation or reclassify as `adhoc_task`.
...
**Purpose:** Expand the IPS into a governance-ready structure.
...
- SAPS artifact following Appendix A template
- Requirement classification table (oracle-verifiable vs portal-arbitrated vs deferred)
...
- SAPS is traceable back to the IPS
...
**Purpose:** Obtain explicit human confirmation that the SAPS is correct.

**Alignment dialogue:**

Present the SAPS to the human and explicitly confirm:
...
- Any corrections incorporated into the SAPS
- Final SAPS version
...
| `saps_artifact` | Final SAPS artifact with version |
...
This evidence becomes input to S1 and is referenced throughout governance authoring.
...
**Purpose:** Outline the approach and decomposition.
