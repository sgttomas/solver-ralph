...
**Naming normalization:** The canonical surface form is `semantic-ralph-loop` (hyphenated, lowercase). See SR-CHARTER § Canonical Type Seeds and §2.11 below for the full terminology mapping.
