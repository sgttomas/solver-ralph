...
- **Directional:** build guidance and scaffolding (plans/directives)—still governed, but not platform-defining semantics. (See SR-CHARTER § Normative status categories.)
