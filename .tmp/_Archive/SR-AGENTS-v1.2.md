...
solver_ralph:
  ...
  ext:
    ...
    agent_model:
      summary: >
        Defines what an Agent is in the SOLVER‑Ralph platform as a single actor kind
        ...
        and how those boundaries are made structurally enforceable via trust boundary
        invariants defined in SR-CONTRACT.
      scope:
      ...
      aligns_with:
        ...
        - "SR-INTENT (trust boundary rationale)"
...
5. **SR-INTENT** (directional rationale; trust boundary design)
6. **SR-GUIDE** (usage guidance)
