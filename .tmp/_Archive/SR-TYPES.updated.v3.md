...
- `governance.directive` — run-scoped execution directive: gates, budgets, stop triggers, portal routing, and enforcement surfaces for a specific build/run. `authority_kind: process`; `normative_status: normative`.
