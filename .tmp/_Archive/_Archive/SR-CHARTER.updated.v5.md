...
- **semantic oracles** (e.g., meaning-matrix / manifold evaluators) produce structured evidence deterministically **within declared environment constraints** (non-deterministic checks are advisory or require portal review) under a declared procedure stage,
...
- **Portal (Trust Boundary / Authority Port):** a human decision point whose recorded output is binding.
