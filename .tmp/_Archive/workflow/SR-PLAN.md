...
solver_ralph:
  ...
  title: "SR-PLAN — SOLVER-Ralph-instance-1"
  version: "1.0.0-draft.3"
  status: "draft"
  normative_status: "normative"
  authority_kind: "process"
  governed_by: ["SR-CHANGE"]
  supersedes: ["SR-PLAN-instance-1@0.1.0-draft.1", "SR-PLAN-instance-1@1.0.0-draft.1", "SR-PLAN_SOLVER-Ralph-instance-1@1.0.0-draft.1", "SR-PLAN-INSTANCE-1@1.0.0-draft.1", "SR-PLAN-instance-1@1.0.0-draft.2"]
  created: "2026-01-11"
  updated: "2026-01-11"
  tags: ["plan", "instance-1", "packages", "deliverables"]
  refs:
    - kind: "Record"
    ...
    - kind: "GovernedArtifact"
      ...
      meta:
        ...
        content_hash: "sha256:1607f32a0a50345ffc0e2ca841e3a4437dc8e94709c9bf68784ef64c50a25eab"
  ext:
    plan:
      template: false
      template_ref: "SR-PLAN@1.0.0-draft.2"
      scope:
      ...
      input_problem_statement_ref:
        ...
        meta:
          ...
          version: "1.0.0-draft.1"
          content_hash: "sha256:5c27764e1747010d4e9dc4b24c25dffa69b0d3b6f8baed8fc2c3d78901043fcb"
      decomposition_strategy: "mixed (type-biased by output class and architectural layer)"
      loop_mapping: "one loop per deliverable (work_unit)"
      package_ids: ['PKG-01', 'PKG-02', 'PKG-03', 'PKG-04', 'PKG-05', 'PKG-06', 'PKG-07', 'PKG-08', 'PKG-09', 'PKG-10', 'PKG-11']
---

# SR-PLAN — SOLVER-Ralph-instance-1 v1.0.0-draft.3

## 0. Change Log

- **v1.0.0-draft.3** (2026-01-11): Tightens SR-PLAN’s non-authority posture by:
  ...
  - explicitly framing the decomposition strategy as a compilation artifact from the authoritative SAPS record into packages/deliverables/dependency edges/evidence hooks.

- **v1.0.0-draft.2** (2026-01-11): Consolidates prior instance-1 plan drafts into a single decomposition aligned with:
  - SR-PLAN template v1.0.0-draft.2,
...
| ID | type_key | version | meta | content_hash (sha256) |
|---|---|---|---|---|
| PS-SOLVER-RALPH-INSTANCE-1-SAPS | record.problem_statement | 1.0.0-draft.1 | stage=SAPS | 5c27764e1747010d4e9dc4b24c25dffa69b0d3b6f8baed8fc2c3d78901043fcb |
| SR-CONTRACT | governance.contract | 1.0.0 |  | f5b42fa4e9e162e63fcdc33366499b98f6a5f1fd2ca9c1b0b5d597776d55eaef |
| SR-SPEC | governance.spec | 1.2.0 |  | a3c45a21e88ea41f9915cbce456986e059f2a0d10e1af91f9f1908513fb59aec |
| SR-DIRECTIVE | governance.directive | 1.1.1 |  | 6ee1f4130d193e1fefd020f5eefa8628bb117cbec04b3d619fb1b879b3551eba |
| SR-TYPES | governance.types | 3.3.0-draft.6 |  | ba60d69e15be9535bee32dd432192e87ec625712c1c860b3fdedc0f2b0da319c |
| SR-PARADIGM | governance.development_paradigm | 1.0.0-draft.8 |  | 27c4561bd883c72bba62453781abc898b5cd3f47b275810c394a9f6e5433abb1 |
| SR-INTENT | governance.intent | 1.1.0-draft.5 |  | 7940bafceb5dda19e70744ccfd58304027b10f0376186d3e87c3dcce79e85d35 |
| SR-CHANGE | governance.change | 2.0.0 |  | c0f631225ac7f0c8f348c3c85b522d50bab3793cfcab7b531c8bef98e075d580 |
| SR-README | governance.readme | 1.0.0 |  | 19caba82029848f6e8e74184060e117cdaff4229e986f4a5f55fcb672ffce2ec |
| SR-ETT | governance.trust_topology | 1.0.1 |  | 32844e0e71268b27586a00cdbb38d71cc4c868d2c31867c902a5ae02fc4a6b2b |
| SR-AGENTS | policy.agent_taxonomy | 1.0.0-draft.1 |  | f2a303ad5fead512ed8250a3eee6db1c2de0b6851b302119024373594cd3ddd9 |
| SR-PLAN | governance.plan | 1.0.0-draft.2 |  | 1607f32a0a50345ffc0e2ca841e3a4437dc8e94709c9bf68784ef64c50a25eab |

**Authority note:** The problem statement meaning is authoritative only as expressed by the committed SAPS record above. Any interpretation here is explicitly non-authoritative.

---

## 2. Orientation Summary (Non-Authoritative)

This instance plan decomposes the build of **SOLVER-Ralph-instance-1** into deliverables that collectively realize:
...
This summary is for navigation only; it MUST NOT replace the SAPS commitment object.
...
- **Compilation artifact:** this plan compiles the authoritative SAPS `record.problem_statement` into typed packages, deliverables, explicit dependency edges, and evidence hooks.
...
|---|---|---|---|
| D-01 | Governance hygiene patchset for instance-1 build | record |  |

#### D-01 — Governance hygiene patchset for instance-1 build
- **Output class:** `record`
...
- **Depends on:** *(none)*
- **Refs required:** `SR-CHANGE`, `SR-CONTRACT`, `SR-SPEC`, `SR-TYPES`, `SR-PARADIGM`, `SR-DIRECTIVE`, `SR-README`, `SR-AGENTS`
...
- **Acceptance criteria:**
  ...
  - Resulting docs remain coherent with SR-CONTRACT, SR-SPEC, SR-TYPES, SR-PARADIGM.
- **Expected evidence:**
...
| D-04 | Local developer tooling (scripts, dev env bootstrap) | candidate | D-02 |
...
- **Depends on:** *(none)*
- **Refs required:** `PS-SOLVER-RALPH-INSTANCE-1-SAPS`, `SR-CONTRACT`, `SR-SPEC`, `SR-DIRECTIVE`
...
#### D-04 — Local developer tooling (scripts, dev env bootstrap)
- **Output class:** `candidate`
...
| D-32 | Bootstrap/init scripts (DB, buckets, identity realm, secrets) | candidate | D-31, D-09, D-16 |
...
#### D-32 — Bootstrap/init scripts (DB, buckets, identity realm, secrets)
- **Output class:** `candidate`
...
- **Expected evidence:**
  - Evidence bundle with bootstrap run logs and resulting resource inventory.
