---
doc_id: SR-GUIDE
doc_kind: governance.usage_guidance
layer: platform
status: draft
refs:
  - rel: governed_by
...
- Layer 1 (build) is necessarily different from Layer 3 (usage)
- The build scaffolding (SR-PLAN, task instructions, approval conversations) is not part of the platform
...
A ralph-loop (the **Work Unit**) is a **bounded, governed instance** of work: it defines scope, budgets, stop triggers, and controlled memory.

A **work-unit iteration** is a **fresh-context execution cycle within the work unit**. A work unit may include one or more iterations.
