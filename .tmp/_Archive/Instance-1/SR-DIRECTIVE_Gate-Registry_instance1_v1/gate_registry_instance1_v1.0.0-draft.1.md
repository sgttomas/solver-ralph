# Gate Registry (Instance-1) — First-pass, fully authored

Generated: 2026-01-11

This registry defines the **binding gate semantics** referenced by the Plan→Workflow mapping for SR-PLAN instance-1.
...
- **Hex surface:** driving_port; domain_core
...
- **Hex surface:** driven_port; adapter; domain_core
...
- **Verification profile / suite:** suite:RUNTIME-SUBSTRATE@v1 (includes STRICT-CORE baseline + runtime invariants)
...
- **Notes:** This gate is meant for *substrate* components whose failures poison downstream work; treat failures as stop-the-line until resolved.
...
- **Hex surface:** domain_core; driven_port; adapter
...
- **Hex surface:** driving_port; domain_core; driven_port
...
- **Verification profile / suite:** profile:STRICT-CORE@v1 (required oracles deterministic; advisory allowed)
...
- **Notes:** Do not downgrade required oracles to advisory without governance change routing; keep STRICT as default unless explicitly allowed for a work-unit.
...
- **Hex surface:** driving_port; domain_core; driven_port; adapter
...
- **Hex surface:** domain_core; driving_port; adapter
...
- **Hex surface:** driving_port; adapter; driven_port
...
- **Hex surface:** adapter; driven_port
...
- **Hex surface:** adapter; driving_port; domain_core; driven_port
...
- **Verification profile / suite:** suite:E2E-HAPPY@v1 (uses STRICT-CORE + portal/freeze validation)
...
- **Notes:** Test harness may use a fixed test human identity; production releases still require real human actors with stable identities.
...
- **Hex surface:** adapter; domain_core; driving_port; driven_port
...
- **Verification profile / suite:** portal:ReleaseApprovalPortal + suite:FREEZE-VALIDATION@v1
...
- **Notes:** Freeze baseline is binding; require explicit exceptions acknowledgement even when empty. Never allow agents to perform approval/freeze actions.
