...
solver_ralph:
  ...
  ext:
    arch_contract:
      ...
      - v1.0.1-draft.1 adds SR-TYPES-aligned `ext.arch_contract.*` index fields, adds a human-readable Invariants Index, and upgrades the Conformance Checklist into a requirement-by-requirement table (no new contract requirements).
      invariants:
      - C-ARCH-1
      - C-ARCH-2
      - C-ARCH-3
  ...
  - kind: GovernedArtifact
    ...
    meta:
      ...
      version: 1.0.6
---
# SOLVER-Ralph Architectural Contract (Why) v1.0.1-draft.1
...
- **Trust boundaries / portals / approvals**: C-TB-1, C-TB-2, C-TB-3, C-TB-4, C-TB-5, C-TB-6
...
- **Evidence integrity**: C-EVID-1, C-EVID-2, C-EVID-3, C-EVID-4, C-EVID-5
...
| **C-EXC-4** — Gate Waiver Required Fields | Oracle + Portal | Gate Waiver record has required fields + scope + expiry; waiver approval; linkage validation | SR-SPEC |
